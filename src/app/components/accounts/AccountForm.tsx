    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#f48a2d] focus:border-transparent"
          {...register("name")}
        />
        {errors.name && (
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full bg-white rounded-full p-2 text-gray-700 border border-[#f48a2d] hover:bg-white cursor-pointer font-semibold"
      >
